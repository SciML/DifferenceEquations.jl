...
function bench_enzyme_batched_fwd_kf!(grad_out, A, B, C, mu_0, Sigma_0, R, y,
        sol_out, cache,
...
function bench_enzyme_reverse_kf!(A, B, C, mu_0, Sigma_0, R, y,
...
function bench_enzyme_batched_fwd_di!(grad_out, A, B, C, u0, noise, y, H,
        sol_out, cache,
...
function bench_enzyme_reverse_di!(A, B, C, u0, noise, y, H,
