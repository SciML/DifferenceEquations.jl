...
gradient(
    (args...) -> make_problem_1(args..., observables_rbc, D_rbc), A_rbc, B_rbc, C_rbc,
    u0_rbc,
    noise_rbc
)
...
gradient(
    (args...) -> make_problem_kalman(args..., observables_rbc, D_rbc), A_rbc, B_rbc,
    C_rbc,
    u0_prior_var_rbc
)
...
gradient(
    (args...) -> kalman_likelihood(args..., observables_FVGQ, D_FVGQ), A_FVGQ, B_FVGQ,
    C_FVGQ,
    u0_prior_var_FVGQ
)
...
const LINEAR["rbc"]["make_problem_1"] = @benchmarkable make_problem_1(
    $A_rbc, $B_rbc,
    $C_rbc,
    $u0_rbc, $noise_rbc,
    $observables_rbc,
...
const LINEAR["rbc"]["make_problem_1_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_1(
        args...,
        $observables_rbc,
        $D_rbc
...
const LINEAR["rbc"]["simulate_model_no_noise_1"] = @benchmarkable simulate_model_no_noise_1(
    $A_rbc,
    $B_rbc,
    $C_rbc,
    $u0_rbc,
...
const LINEAR["rbc"]["simulate_model_no_observations_1"] = @benchmarkable simulate_model_no_observations_1(
    $A_rbc,
    $B_rbc,
    $C_rbc,
    $u0_rbc,
...
const LINEAR["rbc"]["joint_1"] = @benchmarkable joint_likelihood_1(
    $A_rbc, $B_rbc, $C_rbc,
    $u0_rbc,
    $noise_rbc,
    $observables_rbc,
...
const LINEAR["rbc"]["joint_1_gradient"] = @benchmarkable gradient(
    (args...) -> joint_likelihood_1(
        args...,
        $observables_rbc,
        $D_rbc
    ),
...
const LINEAR["rbc"]["make_problem_kalman"] = @benchmarkable make_problem_kalman(
    $A_rbc,
    $B_rbc,
    $C_rbc,
    $u0_prior_var_rbc,
...
const LINEAR["rbc"]["make_problem_kalman_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_kalman(
        args...,
        $observables_rbc,
        $D_rbc
    ),
...
const LINEAR["rbc"]["kalman"] = @benchmarkable kalman_likelihood(
    $A_rbc, $B_rbc, $C_rbc,
    $u0_prior_var_rbc,
    $observables_rbc,
    $D_rbc
)
const LINEAR["rbc"]["kalman_gradient"] = @benchmarkable gradient(
    (args...) -> kalman_likelihood(
        args...,
        $observables_rbc,
        $D_rbc
    ),
...
const LINEAR["FVGQ"]["make_problem_1"] = @benchmarkable make_problem_1(
    $A_FVGQ, $B_FVGQ,
    $C_FVGQ,
    $u0_FVGQ,
    $noise_FVGQ,
...
const LINEAR["FVGQ"]["make_problem_1_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_1(
        args...,
        $observables_FVGQ,
        $D_FVGQ
...
const LINEAR["FVGQ"]["simulate_model_no_noise_1"] = @benchmarkable simulate_model_no_noise_1(
    $A_FVGQ,
    $B_FVGQ,
    $C_FVGQ,
    $u0_FVGQ,
...
const LINEAR["FVGQ"]["simulate_model_no_observations_1"] = @benchmarkable simulate_model_no_observations_1(
    $A_FVGQ,
    $B_FVGQ,
    $C_FVGQ,
    $u0_FVGQ,
...
const LINEAR["FVGQ"]["joint_1"] = @benchmarkable joint_likelihood_1(
    $A_FVGQ, $B_FVGQ,
    $C_FVGQ,
    $u0_FVGQ, $noise_FVGQ,
    $observables_FVGQ,
...
const LINEAR["FVGQ"]["joint_1_gradient"] = @benchmarkable gradient(
    (args...) -> joint_likelihood_1(
        args...,
        $observables_FVGQ,
        $D_FVGQ
...
const LINEAR["FVGQ"]["make_problem_kalman"] = @benchmarkable make_problem_kalman(
    $A_FVGQ,
    $B_FVGQ,
    $C_FVGQ,
    $u0_prior_var_FVGQ,
...
const LINEAR["FVGQ"]["make_problem_kalman_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_kalman(
        args...,
        $observables_FVGQ,
        $D_FVGQ
...
const LINEAR["FVGQ"]["kalman"] = @benchmarkable kalman_likelihood(
    $A_FVGQ, $B_FVGQ, $C_FVGQ,
    $u0_prior_var_FVGQ,
    $observables_FVGQ,
    $D_FVGQ
)
const LINEAR["FVGQ"]["kalman_gradient"] = @benchmarkable gradient(
    (args...) -> kalman_likelihood(
        args...,
        $observables_FVGQ,
        $D_FVGQ
