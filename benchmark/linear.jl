...
function make_problem_1(A, B, C, u0, noise, observables, D; kwargs...)
    prob = LinearStateSpaceProblem(A, B, u0, (0, size(observables, 2)); C,
        observables_noise = D,
...
gradient((args...) -> make_problem_1(args..., observables_rbc, D_rbc), A_rbc, B_rbc, C_rbc,
    u0_rbc,
    noise_rbc)
...
const LINEAR["rbc"]["make_problem_1"] = @benchmarkable make_problem_1($A_rbc, $B_rbc,
    $C_rbc,
    $u0_rbc, $noise_rbc,
    $observables_rbc,
    $D_rbc)
const LINEAR["rbc"]["make_problem_1_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_1(args...,
        $observables_rbc,
        $D_rbc),
    $A_rbc, $B_rbc,
    $C_rbc,
...
const LINEAR["FVGQ"]["make_problem_1"] = @benchmarkable make_problem_1($A_FVGQ, $B_FVGQ,
    $C_FVGQ,
    $u0_FVGQ,
    $noise_FVGQ,
    $observables_FVGQ,
