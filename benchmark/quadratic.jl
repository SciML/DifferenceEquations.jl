...
function simulate_model_no_noise_2(
        A_0, A_1, A_2, B, C_0, C_1, C_2, u0, observables, D;
        kwargs...
    )
    prob = QuadraticStateSpaceProblem(
        A_0, A_1, A_2, B, u0, (0, length(observables)); C_0,
...
function simulate_model_no_observations_2(A_0, A_1, A_2, B, C_0, C_1, C_2, u0, T; kwargs...)
    prob = QuadraticStateSpaceProblem(
        A_0, A_1, A_2, B, u0, (0, T); C_0, C_1, C_2,
        kwargs...
    )
    sol = solve(prob)
    return sol.retcode
...
const A_1_FVGQ = readdlm(
    joinpath(pkgdir(DifferenceEquations), "test/data/FVGQ20_A_1.csv"),
    ','
)
...
const B_2_FVGQ = readdlm(
    joinpath(pkgdir(DifferenceEquations), "test/data/FVGQ20_B.csv"),
    ','
)
C_0_raw = readdlm(joinpath(pkgdir(DifferenceEquations), "test/data/FVGQ20_C_0.csv"), ',')
const C_0_FVGQ = vec(C_0_raw)
const C_1_FVGQ = readdlm(
    joinpath(pkgdir(DifferenceEquations), "test/data/FVGQ20_C_1.csv"),
    ','
)
...
gradient(
    (args...) -> make_problem_2(args..., observables_2_rbc, D_2_rbc), A_0_rbc, A_1_rbc,
...
gradient(
    (args...) -> make_problem_2(args..., observables_2_FVGQ, D_2_FVGQ), A_0_FVGQ,
    A_1_FVGQ,
...
gradient(
    (args...) -> joint_likelihood_2(args..., observables_2_FVGQ, D_2_FVGQ), A_0_FVGQ,
    A_1_FVGQ,
    A_2_FVGQ, B_2_FVGQ, C_0_FVGQ, C_1_FVGQ, C_2_FVGQ, u0_2_FVGQ, noise_2_FVGQ
)

const QUADRATIC["rbc"] = BenchmarkGroup()
const QUADRATIC["rbc"]["make_problem_2"] = @benchmarkable make_problem_2(
    $A_0_rbc, $A_1_rbc,
    $A_2_rbc, $B_2_rbc,
    $C_0_rbc, $C_1_rbc,
    $C_2_rbc,
...
const QUADRATIC["rbc"]["make_problem_2_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_2(
        args...,
        $observables_2_rbc,
        $D_2_rbc
...
const QUADRATIC["rbc"]["simulate_model_no_noise_2"] = @benchmarkable simulate_model_no_noise_2(
    $A_0_rbc,
    $A_1_rbc,
    $A_2_rbc,
    $B_2_rbc,
...
const QUADRATIC["rbc"]["simulate_model_no_observations_2"] = @benchmarkable simulate_model_no_observations_2(
    $A_0_rbc,
    $A_1_rbc,
    $A_2_rbc,
    $B_2_rbc,
...
const QUADRATIC["rbc"]["joint_2"] = @benchmarkable joint_likelihood_2(
    $A_0_rbc, $A_1_rbc,
    $A_2_rbc,
    $B_2_rbc, $C_0_rbc,
    $C_1_rbc,
...
const QUADRATIC["rbc"]["joint_2_gradient"] = @benchmarkable gradient(
    (args...) -> joint_likelihood_2(
        args...,
        $observables_2_rbc,
        $D_2_rbc
    ),
...
const QUADRATIC["FVGQ"]["make_problem_2"] = @benchmarkable make_problem_2(
    $A_0_FVGQ,
    $A_1_FVGQ,
    $A_2_FVGQ,
    $B_2_FVGQ,
...
const QUADRATIC["FVGQ"]["make_problem_2_gradient"] = @benchmarkable gradient(
    (args...) -> make_problem_2(
        args...,
        $observables_2_FVGQ,
        $D_2_FVGQ
...
const QUADRATIC["FVGQ"]["simulate_model_no_noise_2"] = @benchmarkable simulate_model_no_noise_2(
    $A_0_FVGQ,
    $A_1_FVGQ,
    $A_2_FVGQ,
    $B_2_FVGQ,
...
const QUADRATIC["FVGQ"]["simulate_model_no_observations_2"] = @benchmarkable simulate_model_no_observations_2(
    $A_0_FVGQ,
    $A_1_FVGQ,
    $A_2_FVGQ,
    $B_2_FVGQ,
...
const QUADRATIC["FVGQ"]["joint_2"] = @benchmarkable joint_likelihood_2(
    $A_0_FVGQ, $A_1_FVGQ,
    $A_2_FVGQ, $B_2_FVGQ,
    $C_0_FVGQ, $C_1_FVGQ,
    $C_2_FVGQ,
...
const QUADRATIC["FVGQ"]["joint_2_gradient"] = @benchmarkable gradient(
    (args...) -> joint_likelihood_2(
        args...,
        $observables_2_FVGQ,
        $D_2_FVGQ
