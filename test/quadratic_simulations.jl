...
@testset "basic inference, simulated noise" begin
    ...
    @inferred QuadraticStateSpaceProblem(
        A_0_rbc, A_1_rbc, A_2_rbc, B_2_rbc, u0_2_rbc,
        (0, size(observables_2_rbc, 2)); C_0 = C_0_rbc,
...
@testset "basic inference, simulated noise, no observations and no observation noise" begin
    T = 20
    prob = QuadraticStateSpaceProblem(
        A_0_rbc, A_1_rbc, A_2_rbc, B_2_rbc, u0_2_rbc, (0, T);
...
@testset "basic inference, no simulated noise, no observations with observation noise" begin
    ...
    prob_no_noise = QuadraticStateSpaceProblem(
        A_0_rbc, A_1_rbc, A_2_rbc, B_no_noise, u0,
        (0, T);
        C_0 = C_0_rbc, C_1 = C_1_rbc, C_2 = C_2_rbc
    )
    ...
    prob_obs_noise = QuadraticStateSpaceProblem(
        A_0_rbc, A_1_rbc, A_2_rbc, B_no_noise, u0,
        (0, T);
        C_0 = C_0_rbc, C_1 = C_1_rbc, C_2 = C_2_rbc,
        observables_noise = D_2_rbc
    ...
    @inferred QuadraticStateSpaceProblem(
        A_0_rbc, A_1_rbc, A_2_rbc, B_no_noise, u0, (0, T);
        C_0 = C_0_rbc, C_1 = C_1_rbc, C_2 = C_2_rbc,
        observables_noise = D_2_rbc
    )
    ...
    @test maximum(maximum.(sol_tiny_obs_noise.z - sol_no_noise.z)) < 1.0e-7  # still some noise
