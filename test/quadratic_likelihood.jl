...
function joint_likelihood_2(
    ...
    problem = QuadraticStateSpaceProblem(
        A_0, A_1, A_2, B, u0, (0, size(observables, 2));
        C_0, C_1,
...
@testset "quadratic FVGQ joint likelihood" begin
    @test joint_likelihood_2(
        A_0_FVGQ, A_1_FVGQ, A_2_FVGQ, B_2_FVGQ, C_0_FVGQ, C_1_FVGQ,
        C_2_FVGQ,
