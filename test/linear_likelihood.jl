...
@testset "basic inference" begin
    ...
    @inferred joint_likelihood_1(A_rbc, B_rbc, C_rbc, u0_rbc, noise_rbc, observables_rbc,
                                 D_rbc)
end
...
@testset "linear rbc joint likelihood" begin
    @test joint_likelihood_1(A_rbc, B_rbc, C_rbc, u0_rbc, noise_rbc, observables_rbc,
                             D_rbc) ≈
          -690.9407412360038
    @inferred joint_likelihood_1(A_rbc, B_rbc, C_rbc, u0_rbc, noise_rbc, observables_rbc,
                                 D_rbc) # 
    ...
    test_rrule(Zygote.ZygoteRuleConfig(),
               (args...) -> joint_likelihood_1(args..., observables_rbc, D_rbc), A_rbc,
               B_rbc,
...
@testset "linear FVGQ joint likelihood" begin
    ...
    @inferred joint_likelihood_1(A_FVGQ, B_FVGQ, C_FVGQ, u0_FVGQ, noise_FVGQ,
                                 observables_FVGQ,
                                 D_FVGQ)
    test_rrule(Zygote.ZygoteRuleConfig(),
...
@testset "linear FVGQ Kalman" begin
    ...
    gradient((args...) -> kalman_likelihood(args..., observables_FVGQ, D_FVGQ), A_FVGQ,
             B_FVGQ,
             C_FVGQ, u0_FVGQ)
...
@testset "basic kalman failure" begin
    ...
    prob = LinearStateSpaceProblem(A, B_rbc, u0_rbc, (0, size(observables_rbc, 2));
                                   C = C_rbc,
                                   observables_noise = D_rbc, observables = observables_rbc,
