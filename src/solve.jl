...
default_alg(prob::LinearStateSpaceProblem{uType,uPriorType,tType,P,NP,F,AType,BType,CType,RType,ObsType,K,SymsType}) where {uType,uPriorType<:MvNormal,tType,P,NP<:Nothing,F,AType,BType,CType,RType<:MvNormal,ObsType,K,SymsType} = KalmanFilter()
