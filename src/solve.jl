...
default_alg(prob::LinearStateSpaceProblem{uType,uPriorMeanType,uPriorVarType,tType,P,NP,F,AType,BType,CType,RType,ObsType,K}) where {uType,uPriorMeanType,uPriorVarType<:AbstractMatrix,tType,P,NP<:Nothing,F,AType,BType,CType,RType<:AbstractMatrix,ObsType,K} = KalmanFilter()
